  ...
  return (
    ...
    <li className={classes.recipe}>
      <div>
        ...
        <div className={classes.description}>Serving Size: {props.recipe.serving} </div>
      ...
      <div className={classes.buttonCSS}>
        <em><CustomModal id={props.recipe.id} recipe={props.recipe} name="UPDATE RECIPE" 
         onSubmit={onSubmitHandler}
        /></em>
        <Button onClick={DeleteHandler} ><em>{"DELETE"}</em></Button>
